                    ...
                    <form action="{{ route('agenda.update', $agenda->id) }}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('deskripsi') is-invalid @enderror" 
                                ...
                                placeholder="Masukkan deskripsi agenda" required>{{ old('deskripsi', $agenda->deskripsi) }}</textarea>
                            @error('deskripsi')
                                <div class="invalid-feedback d-block">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="date" class="form-control @error('tanggal') is-invalid @enderror" 
                                    id="tanggal" name="tanggal" value="{{ old('tanggal', $agenda->tanggal) }}" required>
                                @error('tanggal')
                                    <div class="invalid-feedback d-block">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="time" class="form-control @error('waktu_selesai') is-invalid @enderror" 
                                    id="waktu_selesai" name="waktu_selesai" value="{{ old('waktu_selesai', $agenda->waktu_selesai) }}">
                                @error('waktu_selesai')
                                    <div class="invalid-feedback d-block">{{ $message }}</div>
                                @enderror
                            </div>
