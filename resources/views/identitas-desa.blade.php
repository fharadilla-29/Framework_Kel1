            ...
            <div class="col-12 wow fadeInUp" data-wow-delay="0.2s">
                ...
                <div style="width: 60px; height: 4px; background-color: #28a745; margin-bottom: 25px;"></div>
                    ...
                    <p style="color: #666; line-height: 1.8; font-size: 1rem; text-align: justify; margin: 0;">
                        {{ isset($profil->sejarah) ? $profil->sejarah : 'Belum ada sejarah singkat desa yang diisi.' }}
                    </p>
                </div>
            </div>
        </div>
                ...
                <div class="card shadow-sm" style="border: none; border-top: 4px solid #ffc107;">
                    <div class="card-body">
                        ...
                        <div style="border-top: 2px solid #ffc107; padding-top: 15px;">
                            ...
                            <p class="mb-2"><strong>Telepon:</strong> {{ isset($profil->telepon) ? $profil->telepon : '-' }}</p>
                            <p class="mb-0"><strong>Email:</strong> {{ isset($profil->email) ? $profil->email : '-' }}</p>
                        </div>
                    </div>
                </div>
            </div>
                            ...
                            <form action="{{ route('profil.update-sejarah') }}" method="POST">
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control @error('sejarah') is-invalid @enderror" 
                                              ...
                                              placeholder="Masukkan sejarah singkat desa">{{ old('sejarah', isset($profil->sejarah) ? $profil->sejarah : '') }}</textarea>
                                    @error('sejarah')
                        ...
                        <div class="card-body p-4">
                            <form action="{{ route('profil.update-kontak') }}" method="POST">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="telepon" name="telepon" value="{{ old('telepon', isset($profil->telepon) ? $profil->telepon : '') }}" placeholder="Masukkan nomor telepon">
                                </div>
                                <div class="mb-3">
                                    <label for="email" class="form-label" style="font-weight: 600;">Email</label>
                                    <input type="email" class="form-control" id="email" name="email" value="{{ old('email', isset($profil->email) ? $profil->email : '') }}" placeholder="Masukkan email">
                                </div>
                ...
                <div class="col-12 wow fadeInUp" data-wow-delay="0.2s">
                    ...
                    <div class="p-4" style="background-color: #f9f9f9; border-radius: 8px; border-left: 5px solid #28a745;">
                        <p style="text-align: justify; color: #666; line-height: 1.8; font-size: 1.1rem; margin-bottom: 0;">
                            {{ isset($profil->sejarah) ? $profil->sejarah : 'Desa Teso Nilo merupakan salah satu desa dengan sejarah panjang yang kaya akan tradisi dan budaya lokal.' }}
                        </p>
                    </div>
                </div>
            </div>
                ...
                <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.4s">
                    ...
                    <div class="p-4" style="background-color: #f9f9f9; border-radius: 8px;">
                        <ul style="color: #666; line-height: 2;">
                            ...
                            <li><strong>Telepon:</strong> {{ isset($profil->telepon) ? $profil->telepon : '-' }}</li>
                            <li><strong>Email:</strong> {{ isset($profil->email) ? $profil->email : '-' }}</li>
                        </ul>
                    </div>
                </div>
            </div>
