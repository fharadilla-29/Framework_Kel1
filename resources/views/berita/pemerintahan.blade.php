                    ...
                    <div class="col-lg-6 col-xl-4 wow fadeInUp" data-wow-delay="0.2s">
                        <div style="background-color: #f9f9f9; border-radius: 8px; overflow: hidden; box-shadow: 0 2px 8px rgba(0,0,0,0.1); position: relative;">
                            ...
                            <div style="position: relative; height: 200px;">
                                ...
                                @else
                                    <img src="{{ $berita->gambar ? asset('storage/' . $berita->gambar) : asset('template/img/berita-pemerintahan1.jpg') }}" class="img-fluid w-100" style="height: 100%; object-fit: cover;" alt="{{ $berita->judul }}">
                                @endif
