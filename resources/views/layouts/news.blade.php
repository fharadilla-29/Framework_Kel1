...
<head>
    ...
    <link rel="shortcut icon" type="image/x-icon" href="{{ asset('aznews/assets/img/favicon.ico') }}">
        ...
        <div class="preloader d-flex align-items-center justify-content-center">
            <div class="preloader-inner position-relative">
                ...
                <div class="preloader-img pere-text">
                    <img src="{{ asset('aznews/assets/img/logo/logo.png') }}" alt="">
                </div>
            </div>
        </div>
    </div>
                        ...
                        <div class="col-xl-12">
                            <div class="row d-flex justify-content-between align-items-center">
                                <div class="header-info-left">
                                    <ul>     
                                        <li><img src="{{ asset('aznews/assets/img/icon/header_icon1.png') }}" alt="">34ºC, Sunny </li>
                                        <li><img src="{{ asset('aznews/assets/img/icon/header_icon1.png') }}" alt="">{{ date('l, d F Y') }}</li>
                                    </ul>
                                </div>
                    ...
                    <div class="container">
                        <div class="row d-flex align-items-center">
                            ...
                            <div class="col-xl-3 col-lg-3 col-md-3">
                                <div class="logo">
                                    <a href="{{ route('news.home') }}"><img src="{{ asset('aznews/assets/img/logo/logo.png') }}" alt=""></a>
                                </div>
                            </div>
                        ...
                        <div class="row align-items-center">
                            <div class="col-xl-10 col-lg-10 col-md-12 header-flex">
                                ...
                                <div class="main-menu d-none d-md-block">
                                    <nav>                  
                                        <ul id="navigation">    
                                            <li><a href="{{ route('news.home') }}">Beranda</a></li>
                                            <li><a href="{{ route('news.index') }}">Berita</a></li>
                                            <li><a href="{{ route('news.category', 'teknologi') }}">Teknologi</a></li>
                                            <li><a href="{{ route('news.category', 'olahraga') }}">Olahraga</a></li>
                                            <li><a href="{{ route('news.category', 'politik') }}">Politik</a></li>
                                            <li><a href="{{ route('news.category', 'kesehatan') }}">Kesehatan</a></li>
                                        </ul>
                                    </nav>
                                </div>
                            </div>             
                        ...
                        <div class="single-footer-caption">
                            <div class="single-footer-caption">
                                ...
                                <div class="footer-logo">
                                    <a href="{{ route('news.home') }}"><img src="{{ asset('aznews/assets/img/logo/logo2_footer.png') }}" alt=""></a>
                                </div>
                                <div class="footer-tittle">
                                    <div class="footer-pera">
                                        <p>Portal berita terkini dan terpercaya menyajikan informasi aktual dari berbagai kategori seperti politik, teknologi, olahraga, dan kesehatan.</p>
                                    </div>
                                </div>
                                <!-- social -->
                    ...
                    <div class="col-xl-3 col-lg-3 col-md-5 col-sm-6">
                        <div class="single-footer-caption mb-50 mt-60">
                            <div class="footer-tittle">
                                <h4>Hubungi Kami</h4>
                                <ul>
                                    <li><a href="#">info@portalberita.com</a></li>
                                    <li><a href="#">+62 812 3456 7890</a></li>
                                    <li><a href="#">Jl. Berita No. 123, Jakarta</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
